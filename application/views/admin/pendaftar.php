    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <a href="<?= base_url('admin/cetak_pendaftar'); ?>" class="btn btn-primary  px-3"><i class="fas fa-print"></i>Cetak</a>
                <a href="<?= base_url('admin/cetak_pendaftar_pdf'); ?>" class="btn btn-danger  px-2"><i class="far fa-file-pdf"></i>PDF</a>
                <a href="<?= base_url('admin/cetak_pendaftar_excel'); ?>" class="btn btn-success  px-2"><i class="far fa-file-excel"></i>Excel</a>
